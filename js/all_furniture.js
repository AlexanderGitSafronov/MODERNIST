...
$('.footer__menu_item_basket').click(function() {
  if($('.container__header_all').hasClass("header__bg_z") && $('.menu__all_furniture-header-fixed').hasClass("header__bg_z_menu")) {
    setTimeout(OpenHeadAll, 500);
  }

  if($('.container__header_all').hasClass("header__bg_z_proff") && $('.menu__all_furniture-header-fixed').hasClass("header__bg_z_menu_all")) {
